...
def montar_comando(*, personalidade, pizzaria_nome: str, decisao: dict[str, Any], ja_apresentou: bool, user_input: str = "") -> str:
    ...
    return (
        ...
        "duas vezes. NUNCA cite preço, total ou taxa em NENHUM valor (R$) — quem mostra os valores ao "
        "cliente é o SISTEMA, não você. Nunca invente preço/sabor/taxa. Não repita bordões fixos "
